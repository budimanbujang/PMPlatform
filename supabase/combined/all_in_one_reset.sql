-- ==========================================================================
-- JCorp PMO Platform — RESET + APPLY combined SQL
-- Drops our public-schema objects first, then applies all migrations + seed.
-- Safe to re-run. Preserves auth.users rows and storage uploads.
-- ==========================================================================
